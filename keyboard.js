...
function createVirtualKeyboard(layout) {
    ...
    // Zeilen erstellen
    const row1 = createKeyboardRow(layouts[layout].row1);
    const row2 = createKeyboardRow(layouts[layout].row2);
    const row3 = createKeyboardRow(layouts[layout].row3);
    const row4 = createKeyboardRow(layouts[layout].row4);
